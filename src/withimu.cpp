...
private:
	...
	message_filters::sync_policies::ApproximateTime<sensor_msgs::PointCloud2,sensor_msgs::Imu> MySyncPolicy;
...
SubscribeAndPublish::SubscribeAndPublish(ros::NodeHandle nh,
        ...
        n_(nh), Sub_Lidar(nh, lidar_topic_name, 20), Sub_Imu(nh, imudata_topic_name,20),
		sync(MySyncPolicy(20), Sub_Lidar, Sub_Imu)
{
